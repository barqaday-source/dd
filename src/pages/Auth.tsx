        ...
        <div className="glass-card shadow-float p-6 page-transition">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            >
              ...
              {/* تدرج لوني خفيف فوقها */}
              <span className="absolute inset-0 rounded-full bg-gradient-to-l from-foreground via-foreground/90 to-foreground" />
              {/* لمعة علوية زجاجية */}
              <span className="absolute top-0 inset-x-3 h-1/2 rounded-t-full bg-gradient-to-b from-white/25 to-transparent" />
